...
export default function KitchenPage() {
  ...
  return (
    <main style={{ padding: '2rem', backgroundColor: '#111827', color: '#fff', minHeight: '100vh', fontFamily: 'sans-serif' }}>
      <h1 style={{ color: '#f472b6', borderBottom: '1px solid #374151', paddingBottom: '1rem' }}>
        👨‍🍳 จอสั่งงานครัว (Realtime)
      </h1>
